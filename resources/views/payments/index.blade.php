                                        ...
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                @if (session('user_roles') == 'Admin')
                                                    <a href="/payments/all" class="btn btn-success text-light">Lihat Semua</a>    
                                                @endif
                                            </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if (session('user_roles') == 'Kasir')
                                                            <td>
                                                                <select onchange="updatePaymentStatus({{$payment->id}})" name="status" id="payment-status" class="form-control" style="width: 160px">
                                                                    <option {{$payment->status == 1 ? 'selected' : ''}} value="1">Sudah Bayar</option>
                                                                    <option {{$payment->status == 0 ? 'selected' : ''}} value="0">Belum Bayar</option>
                                                                </select>   
                                                            </td>
                                                            @endif
                                                        </tr>
